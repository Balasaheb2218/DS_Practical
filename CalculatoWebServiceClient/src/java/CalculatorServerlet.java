...
import myservice.MyClaculatorService_Service;
...
public class CalculatorServerlet extends HttpServlet {
    ...
    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8080/Assignment8/MyClaculatorService.wsdl")
    private MyClaculatorService_Service service;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          num2=Double.parseDouble(request.getParameter(number2));
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>CalculatorServerlet</title>");            
            out.println("</head>");
            out.println("<body>");
    ...
    private double addition(double num1, double num2) {
        ...
        myservice.MyClaculatorService port = service.getMyClaculatorServicePort();
