...
public class ObjectFactory {
    ...
    private final static QName _Addition_QNAME = new QName("http://MyService/", "addition");
    private final static QName _AdditionResponse_QNAME = new QName("http://MyService/", "additionResponse");
    private final static QName _Division_QNAME = new QName("http://MyService/", "division");
    private final static QName _DivisionResponse_QNAME = new QName("http://MyService/", "divisionResponse");
    private final static QName _Multiplication_QNAME = new QName("http://MyService/", "multiplication");
    private final static QName _MultiplicationResponse_QNAME = new QName("http://MyService/", "multiplicationResponse");
    private final static QName _Substraction_QNAME = new QName("http://MyService/", "substraction");
    private final static QName _SubstractionResponse_QNAME = new QName("http://MyService/", "substractionResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MyService/", name = "addition")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MyService/", name = "additionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MyService/", name = "division")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MyService/", name = "divisionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MyService/", name = "multiplication")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MyService/", name = "multiplicationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MyService/", name = "substraction")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MyService/", name = "substractionResponse")
